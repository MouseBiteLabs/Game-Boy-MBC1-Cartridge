...
1) To make this game, you need to have an original Game Boy game that uses an MBC1 mapper chip. <a href="https://catskull.net/gb-rom-database/">You can find a list of games and their mappers here</a>. Use the search function.
